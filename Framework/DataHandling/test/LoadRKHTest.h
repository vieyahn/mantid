...
public:
  ...
  void test1DWithDx() {
    ...
    TS_ASSERT_EQUALS(static_cast<int>(data->histogram(0).dx().size()), 10);
    ...
    TS_ASSERT_DELTA(data->histogram(0).dx()[0], 5.000000e-01, tolerance);
    TS_ASSERT_DELTA(data->histogram(0).dx()[1], 1.207107e+00, tolerance);
    TS_ASSERT_DELTA(data->histogram(0).dx()[2], 1.573132e+00, tolerance);
