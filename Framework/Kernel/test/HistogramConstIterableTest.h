#ifndef MANTID_KERNEL_HISTOGRAM_CONSTITERABLE_TEST_H_
#define MANTID_KERNEL_HISTOGRAM_CONSTITERABLE_TEST_H_
...
#endif /* MANTID_KERNEL_HISTOGRAM_CONSTITERABLE_TEST_H_ */
