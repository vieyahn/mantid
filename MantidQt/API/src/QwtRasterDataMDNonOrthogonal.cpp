...
QwtRasterDataMDNonOrthogonal::QwtRasterDataMDNonOrthogonal() : m_lookPoint(nullptr){
  m_skewMatrix[0] = 1.0;
  m_skewMatrix[1] = 0.0;
  m_skewMatrix[2] = 0.0;
  m_skewMatrix[3] = 0.0;
...
double QwtRasterDataMDNonOrthogonal::value(double x, double y) const {
  ...
  m_lookPoint[m_dimX] = v1 * m_skewMatrix[0 + 3*m_dimX] + v2 * m_skewMatrix[1 + 3*m_dimX] + v3 * m_skewMatrix[2 + 3*m_dimX];
  m_lookPoint[m_dimY] = v1 * m_skewMatrix[0 + 3*m_dimY] + v2 * m_skewMatrix[1 + 3*m_dimY] + v3 * m_skewMatrix[2 + 3*m_dimY];
